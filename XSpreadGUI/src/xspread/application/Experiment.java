...
public class Experiment implements Cloneable {
	...
	public void step() {
		...
		// These writers are in place only so that writing can be performed
		// at each time step if needed.  Otherwise, writing functions are
		// handled by the ExperimentWriter implementation.
