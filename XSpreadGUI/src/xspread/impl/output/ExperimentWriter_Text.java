...
public class ExperimentWriter_Text implements ExperimentWriter {
	...
	public void setWriteCoverMaps(boolean writeCoverMaps) {
		this.writeCoverMaps = writeCoverMaps;
	}
	public void setWriteStageMaps(boolean writeStageMaps) {
		this.writeStageMaps = writeStageMaps;
	}
	public void setWriteMonitoredMaps(boolean writeMonitoredMaps) {
		this.writeMonitoredMaps = writeMonitoredMaps;
	}
}
